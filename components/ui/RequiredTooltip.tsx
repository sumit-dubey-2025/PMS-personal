...
/**
 * ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
 *  Tooltip — reusable tooltip for any element
 * ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
 *
 *  HOW TO USE — add tooltip to any label/element:
 *
 *  import { RequiredTooltip } from '@/components/ui/Tooltip';
 *
 *  Example 1 — mandatory field (shows red asterisk + tooltip on hover):
 *    <label>
 *      Node Name <RequiredTooltip label="Node Name" />
 *    </label>
 *
 *  Example 2 — optional field with custom description:
 *    <label>
 *      Description <RequiredTooltip label="Description" required={false} description="Optional free-text field" />
 *    </label>
 *
 *  Example 3 — mandatory with extra description:
 *    <label>
 *      Node Code <RequiredTooltip label="Node Code" description="Uppercase letters and digits only" />
 *    </label>
 *
 *  Props:
 *    label        — field name shown in tooltip header (use the same text as your label)
 *    required     — default true — shows red asterisk + "Required field" in tooltip
 *    description  — optional extra hint text inside tooltip
 */

import React, { useState, useRef } from 'react';

interface RequiredTooltipProps {
  /** Field name shown in the tooltip header */
  label: string;
...
export function Tooltip({
  ...
  const show = () => {
    // Auto-detect: if button is near top of viewport → open downward
    if (btnRef.current) {
